...
class Qwen3_VL_VisionConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        deepstack_visual_multiscale_indexes=None,
        **kwargs,
    ):
...
class Qwen3_VL_Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3_VL_Model`]. It is used to instantiate a
    ...
    ```python
    >>> from transformers import Qwen3_VL_ForConditionalGeneration, Qwen3_VL_Config

    >>> # Initializing a Qwen3_VL style configuration
    >>> configuration = Qwen3_VL_Config()

    >>> # Initializing a model from the Qwen3-8B style configuration
    >>> model = Qwen3_VL_ForConditionalGeneration(configuration)
    ...
    model_type = "qwen3_vl"
    sub_configs = {"vision_config": Qwen3_VL_VisionConfig}
...
class Qwen3_VL_MoeVisionConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        img_size=4096,
        initializer_range=0.02,
        visual_multiscale_indexes=None,
        **kwargs,
    ):
        super().__init__(**kwargs)
...
class Qwen3_VL_MoeConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3_VL_MoeModel`]. It is used to instantiate a
    Qwen3-VL-MOE model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of
    Qwen3-VL-MoE-A2.7B [Qwen/Qwen3-VL-MoE-A2.7B](https://huggingface.co/Qwen/Qwen3-VL-MoE-A2.7B).
    ...
    ```python
    >>> from transformers import Qwen3_VL_MOEForConditionalGeneration, Qwen3_VL_MOEConfig

    >>> # Initializing a Qwen3_VL_MOE style configuration
    >>> configuration = Qwen3_VL_MOEConfig()

    >>> # Initializing a model from the Qwen3-VL-MoE-A2.7B style configuration
    >>> model = Qwen3_VL_MOEForConditionalGeneration(configuration)
...
class Qwen3OmniMoeThinkerConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3OmniMoeThinkerForConditionalGeneration`]. It is used to instantiate an
    ...
    ```python
    >>> from transformers import Qwen3OmniMoeThinkerForConditionalGeneration, Qwen3OmniMoeThinkerConfig, Qwen3OmniMoeAudioEncoderConfig, Qwen3_VL_VisionConfig

    >>> # Initializing a Qwen3OmniMoeAudioEncoder config
    >>> audio_config = Qwen3OmniMoeAudioEncoderConfig()

    >>> # Initializing a Qwen3OmniMoeVisionEncoder config
    >>> vision_config = Qwen3_VL_VisionConfig()

    >>> # Initializing a Qwen3OmniMoeTextConfig config
    >>> text_config = Qwen3OmniMoeTextConfig()

    >>> # Initializing a Qwen2.5OmniThinker configuration
    >>> configuration = Qwen3OmniMoeThinkerConfig(audio_config, vision_config, text_config)

    >>> # Initializing a model from the Qwen-Omni style configuration
    >>> model = Qwen3OmniMoeThinkerForConditionalGeneration(configuration)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(vision_config, dict):
            vision_config = Qwen3_VL_VisionConfig(**vision_config)
        elif vision_config is None:
            vision_config = Qwen3_VL_VisionConfig()
...
class Qwen3OmniMoeTalkerConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3OmniMoeTalkerModel`]. It is used to instantiate a
    Qwen3OmniMoeTalker model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of [Qwen/Qwen3-15B-A2B](https://huggingface.co/Qwen/Qwen3-15B-A2B).
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 151936):
            Vocabulary size of the Qwen3OmniMoeTalker model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`Qwen3OmniMoeTalkerModel`]
        hidden_size (`int`, *optional*, defaults to 2048):
            Dimension of the hidden representations.
        intermediate_size (`int`, *optional*, defaults to 6144):
            Dimension of the MLP representations.
        ...
        router_aux_loss_coef (`float`, *optional*, defaults to 0.001):
            The aux loss factor for the total loss.
        mlp_only_layers (`list[int]`, *optional*, defaults to `[]`):
            Indicate which layers use Qwen3OmniMoeTalkerMLP rather than Qwen3OmniMoeTalkerSparseMoeBlock
            The list contains layer index, from 0 to num_layers-1 if we have num_layers layers
            If `mlp_only_layers` is empty, `decoder_sparse_step` is used to determine the sparsity.

    ```python
    >>> from transformers import Qwen3OmniMoeTalkerModel, Qwen3OmniMoeTalkerConfig

    >>> # Initializing a Qwen3OmniMoeTalker style configuration
    >>> configuration = Qwen3OmniMoeTalkerConfig()

    >>> # Initializing a model from the Qwen3-15B-A2B" style configuration
    >>> model = Qwen3OmniMoeTalkerModel(configuration)
...
class Qwen3OmniMoeDiTConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of the Qwen3OmniToken2WavDiT used in the Qwen2.5-Omni-Token2Wav model.
...
class Qwen3OmniMoeBigVGANConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of the Qwen3OmniToken2WavBigVGAN module used in the Qwen2.5-Omni-Token2Wav model.
...
class Qwen3OmniMoeToken2WavConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3OmniToken2WavModel`].
    ...
    ```python
    >>> from transformers import Qwen3OmniToken2WavModel, DiT_Args, BigVGAN_Args
    ...
    >>> config = Qwen3OmniMoeToken2WavConfig(dit_config, bigvgan_config)

    >>> # Initialize model with config
    >>> model = Qwen3OmniToken2Wav(config)
    ...
    model_type = "Qwen3_omni_token2wav"
    sub_configs = {
        "dit_config": Qwen3OmniMoeDiTConfig,
        "bigvgan_config": Qwen3OmniMoeBigVGANConfig,
    }
    ...
    def __init__(self, dit_config=None, bigvgan_config=None, **kwargs):
        ...
        if bigvgan_config is None:
            bigvgan_config = {}
        self.dit_config = Qwen3OmniMoeDiTConfig(**dit_config)
        self.bigvgan_config = Qwen3OmniMoeBigVGANConfig(**bigvgan_config)
        super().__init__(**kwargs)
...
class Qwen3OmniMoeConfig(PretrainedConfig):
    ...
    >>> token2wav_config = Qwen3OmniMoeToken2WavConfig()


    >>> # Initializing a module style configuration
    >>> configuration = Qwen3OmniMoeConfig.from_sub_model_configs(
