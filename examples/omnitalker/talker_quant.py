...
fq = True  # False
realq = False
NUM_CALIBRATION_SAMPLES = 1 if flag == "quarot" else 64
...
def preprocess(example):
    conversation = example["messages"][:2]
...
#     }
#     # concatenate batch of dicts into dict of batches
#     # collated = {}
#     # for key in batch[0].keys():
#     #     if key == "pixel_values":
#     #         collated[key] = torch.stack(
#     #             [torch.tensor(example[key], dtype=dtype) for example in batch]
#     #         )
#     #     else:
